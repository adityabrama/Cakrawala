...
| **Indonesian city CCTV portals** (Yogyakarta, Bandung, Banda Aceh, Palembang, Salatiga, Bengkulu, Banjarmasin, Semarang, Sidoarjo, Pekalongan, Depok) | CCTV camera catalogs + live HLS streams, Indonesia | Public city CCTV published for public viewing; Banda Aceh streams are CC BY 4.0 | Each city portal (cctv.jogjakota.go.id, pelindung.bandung.go.id, cctv.bandaacehkota.go.id, cctv.palembang.go.id, cctv.salatiga.go.id, cctv.bengkulukota.go.id, cctv.banjarmasinkota.go.id, pantausemar.semarangkota.go.id, pantaulalindishub.sidoarjokab.go.id, cctv.pekalongankota.go.id, dishub.depok.go.id) |
